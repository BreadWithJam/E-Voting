...
Public Class Auditor
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        With command
            ...
            President.PictureBox8.Image = Image.FromFile(pathstring)
        End With
        President.TextBox14.Text = selected.Cells(0).Value.ToString
        President.TextBox13.Text = selected.Cells(1).Value.ToString
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            With command
                ...
                .Parameters.AddWithValue("@p_CandidateLN", President.TextBox14.Text)
                .Parameters.AddWithValue("@p_CandidateFN", President.TextBox13.Text)
                .ExecuteNonQuery()

                With AssistantAuditor
                    .TopLevel = False
                    Panel1.Controls.Add(AssistantAuditor)
                    .BringToFront()
                    .Show()
                End With
